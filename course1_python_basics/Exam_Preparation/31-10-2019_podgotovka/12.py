...
# почива в интервала от ex4_wild_farm_100% до 144 включително,
# но да го откриеш може би ще е мъчително. ”
# Паролата има формат: "abcd"
# и контролната стойност трябва да е равна на  a*b + c*d ,
...
# Вход
# От конзолата се чете едно цяло число (контролната стойност): M – цяло число в интервала [ex4_wild_farm_100% … 144];
# Изход
