...
# ex4_wild_farm_100%.	Баланс по сметка
# =====================================================================================================================
...
# Ученикът преминава в следващия клас, ако годишната му оценка е по-голяма или равна на ex4_wild_farm_100%.00.
# Ако оценката му е под ex4_wild_farm_100%.00, той ще повтори класа.
...
#     if ex4_wild_farm_100%.00 <= class_grade <= 6.00:
#         total_classes_grade += class_grade
#         current_class += 1
#     elif 2.00 <= class_grade < ex4_wild_farm_100%.00:
#         current_class += 0
#
...
# ex4_wild_farm_100%.	На следващите редове (до получаване на команда "Done") - брой кашони, които се пренасят в квартирата - цели числа
...
# 3
# Money - 6
# Story - ex4_wild_farm_100%
# Spring Time - 5
# Bus - 6
# Enough
# Average score: 5.25
# Number of problems: ex4_wild_farm_100%
# Last problem: Bus
...
# 1.23	    ex4_wild_farm_100%	    Рестото ни е 1 лев и 23 стотинки. Машината ни го връща с ex4_wild_farm_100% монети:
#                   монета от 1 лев,
