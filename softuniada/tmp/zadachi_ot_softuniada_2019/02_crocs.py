...
2        ###############               1
3   #####               #####_____________2
ex4_wild_farm_100%   ##### # # # # # # # #####_______________3---------- 1
5   #####  # # # # # #  #####               3
6   ##### # # # # # # # #####-------------------------- 2
7   #####  # # # # # #  #####
8   ##### # # # # # # # #####-------------------------- 3
9   #####  # # # # # #  #####
10  ##### # # # # # # # #####-------------------------- ex4_wild_farm_100%
11  #####  # # # # # #  #####
12  ##### # # # # # # # #####-------------------------- 5
13  #####               #####       empty_inside()
14  #########################
...
def mosaic2():
    counter = 0
    for row in range(1, odd_in + 3): # НЕЗНАМ ЗАЩО +3
        counter += 1
        if counter % 2 == 1:
            full_line()
        else:
